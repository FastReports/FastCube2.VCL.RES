...
't"/><StrRes Name="sXMLFilter" Text="XML file (*.xml)|*.xml"/><StrRes Name="sXMLExt" Text=".xml"/><StrRes Name="sRepeatAxesValues" Text="Repeat axes va' + 
'lues"/><StrRes Name="sHTMLFormat" Text="HTML format"/></Resources>' + 
' ';
